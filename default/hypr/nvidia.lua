...
local nvidia = paths.zero_path .. "/bin/zero-hw-nvidia"
local nvidia_gsp = paths.zero_path .. "/bin/zero-hw-nvidia-gsp"
local nvidia_without_gsp = paths.zero_path .. "/bin/zero-hw-nvidia-without-gsp"
