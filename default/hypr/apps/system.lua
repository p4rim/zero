...
o.window(
  "(org.zero.btop|org.zero.terminal|org.zero.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|Zero|About|TUI.float|imv|mpv)",
  {
    tag = "+floating-window",
  }
)
...
-- This size only covers the first launch: zero-launch-about measures the
-- rendered content, remembers the size that hugs it, and applies that as its own
-- rule before every later launch.
o.window("org.zero.about", { float = true })
o.window("org.zero.about", { center = true })
o.window("org.zero.about", { size = { 920, 480 } })

-- Fullscreen screensaver.
o.window("org.zero.screensaver", { fullscreen = true })
o.window("org.zero.screensaver", { float = true })
o.window("org.zero.screensaver", { animation = "slide" })
