...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "zero-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("zero polkit agent registered")
      else console.warn("zero polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "zero-polkit"
