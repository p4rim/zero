...
QtObject {
  ...
  readonly property string currentThemePath: stateHome + "/zero/current/theme"
  ...
  // Style. User keys win, so a machine-level `~/.config/zero/shell.toml`
